** /!\ There's a bu currently in this version of the code and therefore is unable to reproduce the results of the ICIP paper. It will be fixed as soon as possible! **
